...
A quanto pare la storia dei test esatti non condizionati per la differenza di proporzioni sui totali marginali è tutt'altro che conclusa:
...
Comunque il test esatto non condizionato é uguale a un test esatto binomiale sulle celle discordanti ($b$ e $c$).
