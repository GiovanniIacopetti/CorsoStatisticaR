---
title: "Esame 2018: generazione dei dati"
output: 
        github_document:
                toc: TRUE
...
A questo punto può essere invitato l'[account GitHub](https://github.com/GiovanniIacopetti/) a collaborare alla repository per la valutazione dell'esame.
Se entro una settimana non ricevete notizia dell'esito inviate una mail ai docenti.
